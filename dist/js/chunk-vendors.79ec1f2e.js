 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const mh=/^__.*__$/;class _h{constructor(e,t,n){this.data=e,this.fieldMask=t,this.fieldTransforms=n}toMutation(e,t){return new sa(e,this.data,this.fieldMask,t,this.fieldTransforms)}}function yh(e){switch(e){case 0:case 2:case 1:return!0;case 3:case 4:return!1;default:throw ri()}}class vh{constructor(e,t,n,r,i,s){this.settings=e,this.databaseId=t,this.serializer=n,this.ignoreUndefinedProperties=r,void 0===i&&this.Pu(),this.fieldTransforms=i||[],this.fieldMask=s||[]}get path(){return this.settings.path}get Iu(){return this.settings.Iu}Tu(e){return new vh(Object.assign(Object.assign({},this.settings),e),this.databaseId,this.serializer,this.ignoreUndefinedProperties,this.fieldTransforms,this.fieldMask)}Eu(e){var t;const n=null===(t=this.path)||void 0===t?void 0:t.child(e),r=this.Tu({path:n,du:!1});return r.Au(e),r}Ru(e){var t;const n=null===(t=this.path)||void 0===t?void 0:t.child(e),r=this.Tu({path:n,du:!1});return r.Pu(),r}Vu(e){return this.Tu({path:void 0,du:!0})}mu(e){return Oh(e,this.settings.methodName,this.settings.fu||!1,this.path,this.settings.gu)}contains(e){return void 0!==this.fieldMask.find((t=>e.isPrefixOf(t)))||void 0!==this.fieldTransforms.find((t=>e.isPrefixOf(t.field)))}Pu(){if(this.path)for(let e=0;e<this.path.length;e++)this.Au(this.path.get(e))}Au(e){if(0===e.length)throw this.mu("Document fields must not be empty");if(yh(this.Iu)&&mh.test(e))throw this.mu('Document fields cannot begin and end with "__"')}}class wh{constructor(e,t,n){this.databaseId=e,this.ignoreUndefinedProperties=t,this.serializer=n||uu(e)}pu(e,t,n,r=!1){return new vh({Iu:e,methodName:t,gu:n,path:Si.emptyPath(),du:!1,fu:r},this.databaseId,this.serializer,this.ignoreUndefinedProperties)}}function bh(e){const t=e._freezeSettings(),n=uu(e._databaseId);return new wh(e._databaseId,!!t.ignoreUndefinedProperties,n)}class Eh extends ph{_toFieldTransform(e){if(2!==e.Iu)throw 1===e.Iu?e.mu(`${this._methodName}() can only appear at the top level of your update data`):e.mu(`${this._methodName}() cannot be used with set() unless you pass {merge:true}`);return e.fieldMask.push(e.path),null}isEqual(e){return e instanceof Eh}}function Th(e,t,n,r){const i=e.pu(1,t,n);Rh("Data must be an object, but it was:",i,r);const s=[],o=Ss.empty();Wi(r,((e,r)=>{const c=Ph(t,e,n);r=(0,a.m9)(r);const u=i.Ru(c);if(r instanceof Eh)s.push(c);else{const e=Ch(r,u);null!=e&&(s.push(c),o.set(c,e))}}));const c=new Zi(s);return new _h(o,c,i.fieldTransforms)}function Ih(e,t,n,r,i,s){const o=e.pu(1,t,n),c=[Ah(t,r,n)],u=[i];if(s.length%2!=0)throw new ai(oi.INVALID_ARGUMENT,`Function ${t}() needs to be called with an even number of arguments that alternate between field names and values.`);for(let a=0;a<s.length;a+=2)c.push(Ah(t,s[a])),u.push(s[a+1]);const l=[],h=Ss.empty();for(let f=c.length-1;f>=0;--f)if(!Dh(l,c[f])){const e=c[f];let t=u[f];t=(0,a.m9)(t);const n=o.Ru(e);if(t instanceof Eh)l.push(e);else{const r=Ch(t,n);null!=r&&(l.push(e),h.set(e,r))}}const d=new Zi(l);return new _h(h,d,o.fieldTransforms)}function Ch(e,t){if(kh(e=(0,a.m9)(e)))return Rh("Unsupported field value:",t,e),Sh(e,t);if(e instanceof ph)return function(e,t){if(!yh(t.Iu))throw t.mu(`${e._methodName}() can only be used with update() and set()`);if(!t.path)throw t.mu(`${e._methodName}() is not currently supported inside arrays`);const n=e._toFieldTransform(t);n&&t.fieldTransforms.push(n)}(e,t),null;if(void 0===e&&t.ignoreUndefinedProperties)return null;if(t.path&&t.fieldMask.push(t.path),e instanceof Array){if(t.settings.du&&4!==t.Iu)throw t.mu("Nested arrays are not supported");return function(e,t){const n=[];let r=0;for(const i of e){let e=Ch(i,t.Vu(r));null==e&&(e={nullValue:"NULL_VALUE"}),n.push(e),r++}return{arrayValue:{values:n}}}(e,t)}return function(e,t){if(null===(e=(0,a.m9)(e)))return{nullValue:"NULL_VALUE"};if("number"==typeof e)return Lo(t.serializer,e);if("boolean"==typeof e)return{booleanValue:e};if("string"==typeof e)return{stringValue:e};if(e instanceof Date){const n=bi.fromDate(e);return{timestampValue:ja(t.serializer,n)}}if(e instanceof bi){const n=new bi(e.seconds,1e3*Math.floor(e.nanoseconds/1e3));return{timestampValue:ja(t.serializer,n)}}if(e instanceof gh)return{geoPointValue:{latitude:e.latitude,longitude:e.longitude}};if(e instanceof dh)return{bytesValue:qa(t.serializer,e._byteString)};if(e instanceof nh){const n=t.databaseId,r=e.firestore._databaseId;if(!r.isEqual(n))throw t.mu(`Document reference is for database ${r.projectId}/${r.database} but should be for database ${n.projectId}/${n.database}`);return{referenceValue:za(e.firestore._databaseId||t.databaseId,e._key.path)}}throw t.mu(`Unsupported field value: ${Yl(e)}`)}(e,t)}function Sh(e,t){const n={};return Ki(e)?t.path&&t.path.length>0&&t.fieldMask.push(t.path):Wi(e,((e,r)=>{const i=Ch(r,t.Eu(e));null!=i&&(n[e]=i)})),{mapValue:{fields:n}}}function kh(e){return!("object"!=typeof e||null===e||e instanceof Array||e instanceof Date||e instanceof bi||e instanceof gh||e instanceof dh||e instanceof nh||e instanceof ph)}function Rh(e,t,n){if(!kh(n)||!function(e){return"object"==typeof e&&null!==e&&(Object.getPrototypeOf(e)===Object.prototype||null===Object.getPrototypeOf(e))}(n)){const r=Yl(n);throw"an object"===r?t.mu(e+" a custom object"):t.mu(e+" "+r)}}function Ah(e,t,n){if((t=(0,a.m9)(t))instanceof fh)return t._internalPath;if("string"==typeof t)return Ph(e,t);throw Oh("Field path arguments must be of type string or ",e,!1,void 0,n)}const Nh=new RegExp("[~\\*/\\[\\]]");function Ph(e,t,n){if(t.search(Nh)>=0)throw Oh(`Invalid field path (${t}). Paths must not contain '~', '*', '/', '[', or ']'`,e,!1,void 0,n);try{return new fh(...t.split("."))._internalPath}catch(b){throw Oh(`Invalid field path (${t}). Paths must not be empty, begin with '.', end with '.', or contain '..'`,e,!1,void 0,n)}}function Oh(e,t,n,r,i){const s=r&&!r.isEmpty(),o=void 0!==i;let a=`Function ${t}() called with invalid data`;n&&(a+=" (via `toFirestore()`)"),a+=". ";let c="";return(s||o)&&(c+=" (found",s&&(c+=` in field ${r}`),o&&(c+=` in document ${i}`),c+=")"),new ai(oi.INVALID_ARGUMENT,a+e+c)}function Dh(e,t){return e.some((e=>e.isEqual(t)))}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function zh(e){e=Jl(e,nh);const t=Jl(e.firestore,ch);return Bl(lh(t),e._key).then((n=>Yh(t,e,n)))}class Hh extends Uh{constructor(e){super(),this.firestore=e}convertBytes(e){return new dh(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new nh(this.firestore,null,t)}}function Wh(e){e=Jl(e,th);const t=Jl(e.firestore,ch),n=lh(t),r=new Hh(t);return Fh(e._query),$l(n,e._query).then((n=>new Bh(t,r,e,n)))}function Kh(e,t,n,...r){e=Jl(e,nh);const i=Jl(e.firestore,ch),s=bh(i);let o;return o="string"==typeof(t=(0,a.m9)(t))||t instanceof fh?Ih(s,"updateDoc",e._key,t,n,r):Th(s,"updateDoc",e._key,t),Qh(i,[o.toMutation(e._key,Yo.exists(!0))])}function Gh(e,...t){var n,r,i;e=(0,a.m9)(e);let s={includeMetadataChanges:!1},o=0;"object"!=typeof t[o]||ah(t[o])||(s=t[o],o++);const c={includeMetadataChanges:s.includeMetadataChanges};if(ah(t[o])){const e=t[o];t[o]=null===(n=e.next)||void 0===n?void 0:n.bind(e),t[o+1]=null===(r=e.error)||void 0===r?void 0:r.bind(e),t[o+2]=null===(i=e.complete)||void 0===i?void 0:i.bind(e)}let u,l,h;if(e instanceof nh)l=Jl(e.firestore,ch),h=io(e._key.path),u={next:n=>{t[o]&&t[o](Yh(l,e,n))},error:t[o+1],complete:t[o+2]};else{const n=Jl(e,th);l=Jl(n.firestore,ch),h=n._query;const r=new Hh(l);u={next:e=>{t[o]&&t[o](new Bh(l,r,n,e))},error:t[o+1],complete:t[o+2]},Fh(e._query)}return function(e,t,n,r){const i=new Dl(r),s=new rl(t,i,n);return e.asyncQueue.enqueueAndForget((async()=>Xu(await ql(e),s))),()=>{i.Na(),e.asyncQueue.enqueueAndForget((async()=>Zu(await ql(e),s)))}}(lh(l),h,c,u)}function Qh(e,t){return function(e,t){const n=new ci;return e.asyncQueue.enqueueAndForget((async()=>fl(await jl(e),t,n))),n.promise}(lh(e),t)}function Yh(e,t,n){const r=n.docs.get(t._key),i=new Hh(e);return new jh(e,i,t._key,r,new Vh(n.hasPendingWrites,n.fromCache),t.converter)}
/**
 * @license
 * Copyright 2022 Google LLC
 *
...
//# sourceMappingURL=chunk-vendors.79ec1f2e.js.map